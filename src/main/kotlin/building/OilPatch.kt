...
class OilPatch : Building() {
    ...
    @io.github.flyingpig525.ksp.BuildingCompanion("RockMiner", UndergroundCategory::class, "oilPatches")
    companion object OilPatchCompanion : BuildingCompanion, Validated {
